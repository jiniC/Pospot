...
### 1 Tour
대한민국 전체 여행 데이터 제공<br>
Tour API 데이터의 분류된 카테고리를 이용해 다른 마커 아이콘으로 지도 위에 데이터 표시 (관광지, 문화시설, 축제/공연/행사, 여행코스, 레포츠, 숙박, 쇼핑, 음식)
<img src="https://github.com/jiniC/Pospot/blob/master/screenshot/pospot_1.png" width="600">

### 2 Pose
투어 마커의 이름으로 인스타그램 게시물 검색<br>
맘에 드는 사진을 필터로 촬영
<img src="" width="600">

### 3 POSTING
내가 다녀온 곳에 포토 마커 생성 / 토글버튼으로 ON OFF<br>
MY 투어로 저장
<img src="https://github.com/jiniC/Pospot/blob/master/screenshot/pospot_3.png" width="600">

### 4 SPOT
인스타그램 태그 수가 많은 장소 추천<br>
현재 위치한 지도에서 인스타그램 태그 수가 많은 장소 5곳을 거리순으로 노출<br>
추천 목록을 통해 SNS에서 인기 있는 장소  파악
